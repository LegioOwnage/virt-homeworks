...
Файл terraform загрузил так же в репозиторий, отдельно описал count и for_each. Вывод terrafrom plan ниже для for_each. Так же прилагаю скрин из yandex cloud. 

![Screenshot from 2022-04-13 14-13-59](https://user-images.githubusercontent.com/89036206/163226770-5d9b9bd4-687c-4c02-be7c-fc55c49fcab7.png)
...
```tf
user@user:~/PycharmProjects/virt-homeworks/07-terraform-03-basic/terraform$ terraform workspace select prod
Switched to workspace "prod".
user@user:~/PycharmProjects/virt-homeworks/07-terraform-03-basic/terraform$ terraform plan
...
Terraform will perform the following actions:
  ...
  # yandex_compute_instance.vm_for_each["standard-v1"] will be created
